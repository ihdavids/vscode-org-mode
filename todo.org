* TODO Things I want [3/38]
	...
	- [-] Formatting [1/5]
		...
		- [ ] Stars highlight properly (theme creator)
	- [ ] Tables [0/5]
...
* Tables 
  - [ ] Investigate Text Tables
  - [ ] Edit CSV
  - [ ] CSV to Table 
  - [ ] Decorators
        [[https://github.com/SeungukShin/org-code/blob/master/src/decoration.ts][Decorators]] 

* Day Page [2/3]
  - [x] Jump to today
  - [x] Prev and Next
  - [ ] Calendar of day pages
        [[https://github.com/SeungukShin/org-code/blob/master/src/calendar.ts][Calendar]] 

* Formatting
  - [ ] Empty star formatting
  - [ ] VsOrg Style Bullets?

* DONE Stuff that has been completed
  - [x] Tab Handler - Stops snippet expansion!
        This was the global tab handler. Have a problem,
		if I replace the global tab handler I have no way to fall back
		on the default key binding at the moment. Is there a way to make that happen??? 
		Miss the sublime text scope based bindings, asked for that as a feature and was told 
		no, they aren't useful.

* TODO Tonight
  - [x] Agenda remove location bit
  - [ ] Agenda make time frame configurable
  - [ ] Agenda color based on tags?
  - [ ] Agenda color based on properties?
  - [ ] Agenda random coloring
  - [ ] Better Agenda font?
  - [x] Agenda font size based on length of title?
  - [x] Agenda click goes to event? Should click be configurable? Go to gcal or property?
        - [ ] Other actions?
  - [ ] Hovers for properties? (Zoom)
